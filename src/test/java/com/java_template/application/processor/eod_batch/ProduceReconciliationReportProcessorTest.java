...
/**
 * Unit tests for ProduceReconciliationReportProcessor.
 */
class ProduceReconciliationReportProcessorTest {

    @Test
    void testSupports_withMatchingName_returnsTrue() {
        ModelSpec modelSpec = new ModelSpec();
        modelSpec.setName("ProduceReconciliationReport");
        OperationSpecification.Entity opSpec = new OperationSpecification.Entity(modelSpec, "ProduceReconciliationReport");

        String expectedName = "ProduceReconciliationReport";
